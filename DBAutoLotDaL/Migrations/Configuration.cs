namespace DBAutoLotDaL.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DBAutoLotDaL.EF.AutoLotEntities>
    {
        ...
        protected override void Seed(DBAutoLotDaL.EF.AutoLotEntities context)
        {
